...
g2 = ggplot(subset(V_deg_dis, grepl("_7|_8|_11|_13|_15|_16|_16.1",signature)), 
...
################################################################
{
   ...
   robustness.dt$PPI_cat = lapply(robustness.dt$signature, function(x) unlist(strsplit(x , '_'))[1]) %>% unlist %>%
    ...
    #                          random btwn.cent
    #   Random edge removal    151876         0
    #   Random vertex removal    8259         0
    #   Targeted edge attack        0    151876
    #   Targeted vertex attack      0      8259
