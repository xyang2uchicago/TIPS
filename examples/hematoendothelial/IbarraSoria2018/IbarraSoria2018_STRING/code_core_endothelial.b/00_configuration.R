## 00_configuration.R — hematoendothelial IbarraSoria2018 (E8.5 mouse gastrulation), STRING arm
...
tips_configure <- function(
    ...
    download_files  = FALSE, # STRING PPIN files + BioTIP.res.RData already present locally; set TRUE to refetch
    wd = here::here("examples", "hematoendothelial", "IbarraSoria2018", "IbarraSoria2018_STRING/"),
    envir = .GlobalEnv
) {
  ...
  data_dir    <- paste0(wd, "../data/")   # IbarraSoria2018/data/, shared with the IID arm
  ...
  message(
    "[tips_configure] hematoendothelial IbarraSoria2018_STRING species=", species,
