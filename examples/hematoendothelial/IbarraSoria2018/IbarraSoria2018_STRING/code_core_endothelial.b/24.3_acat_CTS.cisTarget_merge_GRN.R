rebuild_mat <- FALSE
source(here::here("examples", "hematoendothelial", "IbarraSoria2018", "IbarraSoria2018_STRING", "code_core_endothelial.b", "24.0_acat_load_input_clean.R"))
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = 12   ecount = 28
