## hematoendothelial IbarraSoria2018 (E8.5 mouse gastrulation) — STRING arm, focal cluster endothelial.b
## Full docs: README.md in this folder (if present)
## USER PARAMETERS below → tips_configure() → 11.1 … 24.3
##
## NOTE: this dataset has no 11.1.1 step (no vertex-duplication issue was
## found for the IbarraSoria2018 STRING graph).
