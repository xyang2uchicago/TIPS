## 00_configuration.R — hematoendothelial GSE87038 (E8.25 mouse gastrulation), STRING arm
...
tips_configure <- function(
    ...
    wd = here::here("examples", "hematoendothelial", "GSE87038", "GSE87038_STRING/"),
    envir = .GlobalEnv
) {
  ...
  message(
    "[tips_configure] hematoendothelial GSE87038_STRING species=", species,
