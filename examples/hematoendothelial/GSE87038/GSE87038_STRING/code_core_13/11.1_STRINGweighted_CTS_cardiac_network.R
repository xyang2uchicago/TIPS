...
if(download_files){
    ...
    if (!dir.exists(paste0(shared_data_path, "/PPIN"))) {
        dir.create(paste0(shared_data_path, "/PPIN"))
    }

    for (f in files) {
        download.file(paste0(base_url, "/", f), paste0(shared_data_path, "/PPIN/", basename(f)))
    }
}
...
########################
logFC.cut <- 0.6 # DEG threshold for all networks (HiG, HiGCTS, DEG file)
...
#                    name vcount ecount
# HiG_1             HiG_1    420  18844
# HiG_2             HiG_2    563  30324
# HiG_3             HiG_3    547  24650
# HiG_4             HiG_4    421  19022
# HiG_5             HiG_5    426  19322
# HiG_6             HiG_6    635  30414
# HiG_9             HiG_9    479  24094
# HiG_10           HiG_10    574  30860
# HiG_12           HiG_12    450  20932
# HiG_14           HiG_14    472  22912
# HiG_17           HiG_17    647  32240
# HiG_18           HiG_18    576  25654
# HiG_19           HiG_19    674  24972
# HiG_7             HiG_7    408  20068
# HiG_11           HiG_11    570  30982
# HiG_15           HiG_15    533  27978
# HiG_16           HiG_16    656  30236
# HiG_13           HiG_13    529  27460
# HiG_8             HiG_8    447  20556
# HiGCTS_7       HiGCTS_7     17     40
# HiGCTS_11     HiGCTS_11     23     36
# HiGCTS_15     HiGCTS_15     44    220
# HiGCTS_16     HiGCTS_16     17     24
# HiGCTS_16.1 HiGCTS_16.1     36     80
# HiGCTS_13     HiGCTS_13     15     32
# HiGCTS_8       HiGCTS_8     12     28
# CTS_7             CTS_7     31    104
...
# See which graphs have duplicates (handled by 11.1.1)
