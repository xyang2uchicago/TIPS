...
# annotation_fetal_0 = read.xlsx(xlsxFile = paste0(db_specifc_input_path, 'Ameen2022cell_media-1.xlsx'), sheet = 4)  
...
subset(annotation_fetal, name=='NR2F1')
#      Chromosomes    start      end strand  name   Log2FC          FDR  MeanDiff
# 16          chr5 93583337 93594615      1 NR2F1 1.413042 2.660821e-15 1.0611595
# 1335        chr5 93583337 93594615      1 NR2F1 1.307391 2.632281e-15 0.8509144
# 2240        chr5 93583337 93594615      1 NR2F1 1.045637 1.348804e-03 0.7674762
#      Cluster
# 16       aCM
# 1335   Endo1
# 2240     lEC
subset(annotation_fetal, name=='IRX5')
# [1] Chromosomes start       end         strand      name        Log2FC     
# [7] FDR         MeanDiff    Cluster
# <0 rows> (or 0-length row.names)
subset(annotation_fetal, name=='ALX1')
# [1] Chromosomes start       end         strand      name        Log2FC
# [7] FDR         MeanDiff    Cluster 
...
# TRUE
names(Ameen_annotation_list)
#  [1] "iPSC"      "iPSC-Mes"  "i-Mes"     "i-CP"      "i-MyoF"    "i-Mes-End"
#  [7] "i-pCM"     "i-CM"      "i-EC"      "i-EPC"     "i-SMC"     "i-CF"
# [13] "aCM"       "aEC"       "Cap"       "CF"        "CFP"       "eCM"      
# [19] "Endo1"     "Endo2"     "EPC"       "FB1"       "FB2"       "lEC"
# [25] "NC"        "OFT"       "PC"        "preCF"     "preSMC"    "vCM"
# [31] "vEC"       "SMC"
...
if(!file.exists(file= "cisTarget_targets_in_all_CTS.rds")) {
	...
	# --- 1) calcualte the enriched motifs among linegae-specific HiGs
