...
graph_list <- readRDS(file.path(inputdir, paste0(db, "_IID_graph_perState_notsimplified.rds")))
...
# # Check for duplicate vertex names in each graph
# dup_name_counts <- sapply(graph_list, function(g) sum(duplicated(V(g)$name)))
...
# #All can be skipped since no duplicated vertex names in any graph
...
#  6:       CTS_7     CTS        1
#  7:       CTS_8     CTS        1
#  8:   HiGCTS_11  HiGCTS        1
#  9:   HiGCTS_13  HiGCTS        1
# 10:   HiGCTS_15  HiGCTS        1
# 11:   HiGCTS_16  HiGCTS        1
# 12: HiGCTS_16.1  HiGCTS        1
# 13:    HiGCTS_7  HiGCTS        1
# 14:    HiGCTS_8  HiGCTS        1
# 15:      HiG_10     HiG        2
# 16:      HiG_19     HiG        2
# 17:       HiG_4     HiG        2
# 18:       HiG_5     HiG        2
...
print(dim(V_deg_dis)) # [1] 91  6
print(head(V_deg_dis, 3))
#    signature strength_distribution     k PPI_cat cluster n_nodes
#       <char>                 <num> <int>  <fctr>  <char>   <num>
# 1:     HiG_1           1.000000000     1     HiG       1     273
# 2:     HiG_1           0.113553114     2     HiG       1     273
# 3:     HiG_1           0.007326007     3     HiG       1     273
