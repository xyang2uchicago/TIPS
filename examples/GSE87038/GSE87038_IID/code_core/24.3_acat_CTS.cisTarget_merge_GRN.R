rebuild_mat <- FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/GSE87038/GSE87038_IID/code_core/24.0_acat_load_input_clean.R")
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = 2    ecount = 1
    # CM merged graph: vcount = 6    ecount = 5
