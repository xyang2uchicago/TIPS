CF_cluster = '19'  # mesenchymal/ECM‑high (“CF‑like”).
if(length(CF_cluster)==1) EMT_ID  = CF_cluster else EMT_ID = 'C3C16C18C19'

rebuild_mat = FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/GSE87038/code_19/24.0_acat_load_input_clean.R")

CTS_ID = '8'
celltype_col  = "label"

updir <- "/Users/felixyu/Documents/GitHub/TIPS/examples/GSE87038/results/GSE181346_heart_scATAC_C19"
