...
source(paste0('../code/BioTIP_update_', BioTIP_version, '.R'))
...
#'   \item \code{weight}: Final combined edge weights (normalized PPI * specificity). A positive numeric vector. Larger edge weights correspond to stronger connections.
