rebuild_mat <- FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/GSE87038/GSE87038_STRING/code_core/24.0_acat_load_input_clean.R")
...
# [1] "PPI_graph_GRN_prediction_CTS_8_dualpull_final_table.tsv"
...
key_TFs
# [1] "HMGA2" "RARB"
# (TCF3 excluded: no _final.rds files saved — vcount = 0 for both CM and CF)
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = ...   ecount = ...
    # CM merged graph: vcount = ...   ecount = ...
