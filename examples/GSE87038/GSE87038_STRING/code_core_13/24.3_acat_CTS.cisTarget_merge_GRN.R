rebuild_mat <- FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/GSE87038/GSE87038_STRING/code_core_13/24.0_acat_load_input_clean.R")
...
# [1] "PPI_graph_GRN_prediction_CTS_13_dualpull_final_table.tsv"
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = 16  ecount = 21
    # CM merged graph: vcount = 4   ecount = 2
