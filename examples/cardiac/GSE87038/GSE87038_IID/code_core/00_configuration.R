## 00_configuration.R — cardiac GSE87038 (E8.25 mouse gastrulation), IID arm
##
...
tips_configure <- function(
    ...
    wd = here::here("examples", "cardiac", "GSE87038", "GSE87038_IID/"),
    envir = .GlobalEnv
) {
  ...
  message(
    "[tips_configure] GSE87038_IID species=", species,
