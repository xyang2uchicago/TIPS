...
t.test(vals1, vals2, paired = TRUE, alternative = "greater") # p-value = 2.295e-05
...
# Error in t.test.default(vals1, vals2, paired = TRUE, alternative = "greater") :
...
vals2 <- df_subset$normalized_AUC[df_subset$network == "deg_preserving"]
t.test(vals1, vals2, paired = TRUE, alternative = "greater") # p-value = 2.295e-05
t.test(vals1, vals2, paired = TRUE) # p-value = 4.591e-05
wilcox.test(vals1, vals2, paired = TRUE) # p-value = 0.03125
