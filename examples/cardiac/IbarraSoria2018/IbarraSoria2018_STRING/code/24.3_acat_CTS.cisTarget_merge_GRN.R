...
updir <- here::here("examples", "cardiac", "IbarraSoria2018", "IbarraSoria2018_STRING", "results", "GSE181346_heart_scATAC")
...
db_specifc_input_path <- here::here("examples", "cardiac", "IbarraSoria2018", "IbarraSoria2018_STRING", "results")
