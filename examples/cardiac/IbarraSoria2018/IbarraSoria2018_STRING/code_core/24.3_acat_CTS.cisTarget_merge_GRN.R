rebuild_mat <- FALSE
source(here::here("examples", "cardiac", "IbarraSoria2018", "IbarraSoria2018_STRING", "code_core", "24.0_acat_load_input_clean.R"))
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = 8    ecount = 12
    # CM merged graph: vcount = 15   ecount = 36
