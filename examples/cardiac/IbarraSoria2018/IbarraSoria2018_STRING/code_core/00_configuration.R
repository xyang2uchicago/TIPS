## 00_configuration.R — cardiac IbarraSoria2018 (E8.5 mouse gastrulation), STRING arm
##
...
tips_configure <- function(
    ...
    wd = here::here("examples", "cardiac", "IbarraSoria2018", "IbarraSoria2018_STRING/"),
    envir = .GlobalEnv
) {
  ...
  message(
    "[tips_configure] IbarraSoria2018_STRING species=", species,
