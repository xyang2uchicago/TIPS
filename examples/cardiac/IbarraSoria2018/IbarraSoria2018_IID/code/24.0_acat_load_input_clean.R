...
# annotation_fetal = read.xlsx(xlsxFile = paste0(db_specifc_input_path, 'Ameen2022cell_media-1.xlsx'), sheet = 4)
...
subset(annotation_fetal, name == "GATA4")
# [1] Chromosomes start       end         strand      name        Log2FC
# [7] FDR         MeanDiff    Cluster
# <0 rows> (or 0-length row.names)
subset(annotation_fetal, name == "TBX5")
#      Chromosomes     start       end strand name   Log2FC          FDR
# 10         chr12 114408442 114353931      2 TBX5 1.780172 2.436709e-17
# 1134       chr12 114408442 114353931      2 TBX5 1.208002 5.313268e-07
#       MeanDiff Cluster
# 10   0.8183439     aCM
# 1134 0.5282948     eCM
subset(annotation_fetal, name == "MSX2")
# [1] Chromosomes start       end         strand      name        Log2FC
# [7] FDR         MeanDiff    Cluster
# <0 rows> (or 0-length row.names)
# subset(annotation_fetal, name=='GATA6')
#      Chromosomes    start      end strand  name   Log2FC          FDR  MeanDiff
# 1100       chr18 22169443 22202528      1 GATA6 1.259555 4.540621e-10 0.8938820
# 3010       chr18 22169443 22202528      1 GATA6 1.054655 4.222853e-08 0.7517266
#      Cluster
# 1100     eCM
# 3010     vCM
# subset(annotation_fetal, name=='MEF2C')
# [1] Chromosomes start       end         strand      name        Log2FC
# [7] FDR         MeanDiff    Cluster
# <0 rows> (or 0-length row.names)
...
# 1100     eCM
# 3010     vCM
# subset(annotation_fetal, name=='GATA5')
#      Chromosomes    start      end strand  name   Log2FC          FDR  MeanDiff
# 2145       chr20 62475970 62463497      2 GATA5 1.211969 3.492111e-07 0.6752488
#      Cluster
# 2145     FB2
# GATA4 is not within annotation_fetal, but GATA5 and 6 are, with 6 being present in the top 4 TF's
...
if (!file.exists(file = "cisTarget_targets_in_all_CTS.rds")) {
  ...
  #   3.030   3.170   3.305   3.554   3.678   5.840
