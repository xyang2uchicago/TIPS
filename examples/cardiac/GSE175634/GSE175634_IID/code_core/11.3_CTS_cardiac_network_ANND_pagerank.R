...
edge_counts
    ...
    #        4191           13632            2504             510            1096 
    #       HiG_5           HiG_6           HiG_7      HiG_muscle           HiG_9 
    #        1684             303             550             923           18379 
...
# 1 CTS_CP    AFAP1L2  0.00377 CTS            0                 1           42       51.5
# 2 CTS_CP    ARHGAP…  0.00377 CTS            0                 1           42       51.5
# 3 CTS_CP    ARL4C    0.0598  CTS            3.09e-18          1           42        1  
# 4 CTS_CP    ARRDC3   0.00377 CTS            0                 1           42       51.5
# 5 CTS_CP    ASH2L    0.0251  CTS            4.98e-18          1           42       15.5
# 6 CTS_CP    ATF7IP2  0.00377 CTS            0                 1           42       51.5
...
#   signature   gene  PageRank PPI_cat EigenCentrality p.PageRank rank_by_p.PR rank_by_PR
#   <chr>       <chr>    <dbl> <fct>             <dbl>      <dbl>        <dbl>      <dbl>
# 1 CTS_CP.1    ISL1  0.00350  CTS            1.18e-16      1             41         54.5
# 2 HiGCTS_CP.1 ISL1  0.0121   HiGCTS         0             1             13.5       18.5
# 3 HiG_1       ISL1  0.000226 HiG            1.39e- 6      0.939        192.       924  
# 4 HiG_5       ISL1  0.00170  HiG            2.27e- 5      0.946          7.5      171  
# 5 HiG_9       ISL1  0.000519 HiG            7.62e- 6      0.973        319        642  
# 6 HiG_CP      ISL1  0.00154  HiG            9.80e-18      0.911         84        106  
...
# 1    CTS_CP    ARL4C 0.05975825     CTS    3.089812e-18          1           42
# 2    CTS_CP    ASH2L 0.02512563     CTS    4.977504e-18          1           42
# 3    CTS_CP BAIAP2L1 0.01038942     CTS    3.005031e-18          1           42
#   rank_by_PR annd p.annd     strength rank_by_strength normalized.strength
# 1        1.0    1      0 0.0013140887               16        1.991043e-05
# 2       15.5    1      0 0.0006862718               28        1.039806e-05
# 3       27.0    4      0 0.0001712789               34        2.595134e-06
...
# 66   HiGCTS_muscle                    30  HSPB1        3.0  HiGCTS           FALSE
# 67   HiGCTS_muscle                    60  ACTA1        1.0  HiGCTS           FALSE
# 68   HiGCTS_muscle                    14   MAP4        5.0  HiGCTS           FALSE
# 69   HiGCTS_muscle                    18  ACTC1        4.0  HiGCTS            TRUE
# 70   HiGCTS_muscle                    31   CNN1        2.0  HiGCTS           FALSE
# 71 HiGCTS_endoderm                     4  APOA1        1.5  HiGCTS           FALSE
# 72 HiGCTS_endoderm                     2  APOA2        3.0  HiGCTS           FALSE
# 73 HiGCTS_endoderm                     4  APOC1        1.5  HiGCTS           FALSE
# 74       HiGCTS_CP                    13   BMP4        2.0  HiGCTS            TRUE
# 75       HiGCTS_CP                     1    VIM        5.0  HiGCTS           FALSE
# 76       HiGCTS_CP                     7 PDGFRA        3.5  HiGCTS            TRUE
# 77       HiGCTS_CP                     7  HOXB2        3.5  HiGCTS           FALSE
# 78       HiGCTS_CP                    21  PRRX1        1.0  HiGCTS           FALSE
# 79     HiGCTS_CP.1                     1    ID1        1.5  HiGCTS           FALSE
# 80     HiGCTS_CP.1                     1  FGF10        1.5  HiGCTS           FALSE


	(df5_CHD = subset(df5, PCGC_AllCurated==TRUE))
#        signature BetweennessCentrality   gene rank_by_BC PPI_cat PCGC_AllCurated
# 16        HiG_CP                  2067   BMP4        1.0     HiG            TRUE
# 17        HiG_CP                   605  RPL11        5.0     HiG            TRUE
# 23         HiG_4                   463   BMP4        2.0     HiG            TRUE
# 27         HiG_5                  7402  ACTC1        3.0     HiG            TRUE
# 47         HiG_9                117744  ACTC1        3.0     HiG            TRUE
# 53        HiG_10                   210  RPS19        4.0     HiG            TRUE
# 69 HiGCTS_muscle                    18  ACTC1        4.0  HiGCTS            TRUE
# 74     HiGCTS_CP                    13   BMP4        2.0  HiGCTS            TRUE
# 76     HiGCTS_CP                     7 PDGFRA        3.5  HiGCTS            TRUE
# 92        CTS_CP                   114   BMP4        2.0     CTS            TRUE
# 93        CTS_CP                    54 PDGFRA        4.0     CTS            TRUE
# 97      CTS_CP.1                   110  GATA6        4.0     CTS            TRUE
    ...
    ks.test(df_median$bc.median[a], df_median$bc.median[b]) # p-value =  0.097  HiG vs HiGCTS
    ks.test(df_median$bc.median[a], df_median$bc.median[c]) # p-value =   0.097	HiG vs CTS
	ks.test(df_median$bc.median[b], df_median$bc.median[c]) # p-value =  1	HiGCTS vs CTS
	wilcox.test(df_median$bc.median[a], df_median$bc.median[b]) # p-value = 0.057  HiG vs HiGCTS
    wilcox.test(df_median$bc.median[a], df_median$bc.median[c]) # p-value =  0.057	HiG vs CTS
	wilcox.test(df_median$bc.median[b], df_median$bc.median[c]) # p-value = NA	HiGCTS vs CTS
	t.test(df_median$bc.median[a], df_median$bc.median[b]) # p-value = 0.085  HiG vs HiGCTS
    t.test(df_median$bc.median[a], df_median$bc.median[c]) # p-value =  0.085	HiG vs CTS
...
#        signature   gene   PageRank PPI_cat EigenCentrality p.PageRank rank_by_p.PR
# 1         CTS_CP   BMP4 0.05500906     CTS      0.46039044      0.999         11.0
# 2         CTS_CP PDGFRA 0.04453115     CTS      0.28369811      0.998          3.0
# 3      HiGCTS_CP   BMP4 0.09716377  HiGCTS      0.00000000      0.999          5.5
# 4  HiGCTS_muscle  ACTC1 0.10295359  HiGCTS      0.58905344      0.990         11.5
# 5         HiG_10  RPL11 0.03248150     HiG      0.72984284      0.917         55.0
# 6         HiG_10  RPS19 0.03500807     HiG      0.90003891      0.892         49.5
# 7         HiG_12   MYH7 0.12932258     HiG      0.00000000      0.999          3.0
# 8          HiG_4  RPS19 0.02819810     HiG      1.00000000      0.854         64.0
# 9         HiG_CP   BMP4 0.02408685     HiG      0.03334468      0.874         53.0
# 10        HiG_CP  RPS19 0.02373276     HiG      0.78789954      0.960         71.5
#    rank_by_PR      annd p.annd    strength rank_by_strength normalized.strength
# 1           3  3.290567      0 0.006070734                3        9.198082e-05
# 2           5  2.953902      0 0.004511814                9        6.836082e-05
# 3           2  2.149202      0 0.003811058                2        1.465791e-04
# 4           3  5.082328      0 0.018377162                3        1.020953e-03
# 5           5 35.634569      0 0.159823703                5        2.708876e-03
# 6           3 36.390865      0 0.177008559                2        3.000145e-03
# 7           2  6.000000      0 0.001148046                4        6.042349e-05
# 8           3 45.789862      0 0.208131610                2        2.420135e-03
# 9           3 13.899756      0 0.015566509               27        1.341940e-04
# 10          4 27.783816      0 0.141763955                3        1.222103e-03
...
#  }   
 ...
 df = readRDS(file='df_PAGERANK_strength_ANND.rewring.P.rds')  #!!!!!!!!!!!!!!!!!!!!!!!
    ...
    ks.test(df_median$median_normalized_strength[C], df_median$median_normalized_strength[B]) # p-value =  0.484  HiG vs HiGCTS
    ks.test(df_median$median_normalized_strength[C], df_median$median_normalized_strength[A]) # p-value =  0.90.98	HiG vs CTS
	ks.test(df_median$median_normalized_strength[B], df_median$median_normalized_strength[A]) # p-value =  0.77	HiGCTS vs CTS
	wilcox.test(df_median$median_normalized_strength[C], df_median$median_normalized_strength[B]) # p-value = 0.2017  HiG vs HiGCTS
