...
if(length(files) > 0)  {
	...
	keys
     keys
# [1] "CEBPA;CEBPB;CEBPD;CEBPE;CEBPG;PDX1;SOX9;SRY;TEAD1"                                                                                                                                               
# [2] "SPIB"                                                                                                                                                                                            
# [3] "EZH2"                                                                                                                                                                                            
# [4] "PATZ1;VEZF1;ZNF467"                                                                                                                                                                              
# [5] "PARP1"                                                                                                                                                                                           
# [6] "DLX2;DLX3;DRGX;ELF1;ELF2;ELF3;ELF4;ELK1;ELK3;ELK4;ERF;ERG;ETS1;ETS2;ETV1;ETV2;ETV3;ETV4;ETV5;ETV7;FEV;FLI1;FOXO1;GABPA;GABPB1;GATAD1;HOXA2;HOXA3;KMT2B;ONECUT2;SOX15;TFAP2C;ZBTB11;ZBTB25;ZNF580"
# [7] "SOX9;TEAD1"                                                                                                                                                                                      
# [8] "PATZ1"                                                                                                                                                                                           
# [9] "ETV2;ONECUT2" 
	length(keys)  # 9
	...
	for(key in keys){
		...
		which(tmp==0)
		# PCW19_CM_access PCW19_CF_access PCW8_SMC_access 
        #           7               9              10 
	...
	dim(mat) #[1] 76 38  all CTS.CP genes !!  for CTS.CP, we should study key TFs such as PRRX1 !!!!!!
	colnames(mat)
#[1] "CMES_hi"                                                                                                                                                                                                                
#  [2] "CP_hi"                                                                                                                                                                                                                  
#  [3] "CM_hi"                                                                                                                                                                                                                  
...
# [15] "iEPC_access"                                                                                                                                                                                                            
# [16] "CTS_CP"                                                                                                                                                                                                                 
# [17] "Maven2023_gene_ISL1_up_E"                                                                                                                                                                                               
# [18] "Maven2023_gene_ISL1_up_T"                                                                                                                                                                                               
# [19] "Maven2023_gene_ISL1_up_L"                                                                                                                                                                                               
# [20] "Maven2023_gene_ISL1_dn_E"                                                                                                                                                                                               
# [21] "Maven2023_gene_ISL1_dn_T"                                                                                                                                                                                               
# [22] "Maven2023_gene_ISL1_dn_L"                                                                                                                                                                                               
# [23] "Maven2023_gene_ISL1_WT_d6CP"                                                                                                                                                                                            
# [24] "Gao2019_gene_Isl1_E825E9.bound"                                                                                                                                                                                         
# [25] "Gao2019_gene_Isl1.iCPC_CPC.bound"                                                                                                                                                                                       
# [26] "ISL1_CP_bound"                                                                                                                                                                                                          
# [27] "ISL1_CP_candidate"                                                                                                                                                                                                      
# [28] "ISL1_CM_candidate"                                                                                                                                                                                                      
# [29] "ISL1_CF_candidate"                                                                                                                                                                                                      
#[30] "cisTarget_CEBPA;CEBPB;CEBPD;CEBPE;CEBPG;PDX1;SOX9;SRY;TEAD1.motif_target"                                                                                                                                               
# [31] "cisTarget_SPIB.motif_target"                                                                                                                                                                                            
# [32] "cisTarget_EZH2.motif_target"                                                                                                                                                                                            
# [33] "cisTarget_PATZ1;VEZF1;ZNF467.motif_target"                                                                                                                                                                              
# [34] "cisTarget_PARP1.motif_target"                                                                                                                                                                                           
# [35] "cisTarget_DLX2;DLX3;DRGX;ELF1;ELF2;ELF3;ELF4;ELK1;ELK3;ELK4;ERF;ERG;ETS1;ETS2;ETV1;ETV2;ETV3;ETV4;ETV5;ETV7;FEV;FLI1;FOXO1;GABPA;GABPB1;GATAD1;HOXA2;HOXA3;KMT2B;ONECUT2;SOX15;TFAP2C;ZBTB11;ZBTB25;ZNF580.motif_target"
# [36] "cisTarget_SOX9;TEAD1.motif_target"                                                                                                                                                                                      
# [37] "cisTarget_PATZ1.motif_target"                                                                                                                                                                                           
# [38] "cisTarget_ETV2;ONECUT2.motif_target"                                                                                                                                                                                             
    ...
    x
# [1] "CEBPA"   "CEBPB"   "CEBPD"   "CEBPE"   "CEBPG"   "PDX1"    "SOX9"    "SRY"    
#  [9] "TEAD1"   "SPIB"    "EZH2"    "PATZ1"   "VEZF1"   "ZNF467"  "PARP1"   "DLX2"   
# [17] "DLX3"    "DRGX"    "ELF1"    "ELF2"    "ELF3"    "ELF4"    "ELK1"    "ELK3"   
# [25] "ELK4"    "ERF"     "ERG"     "ETS1"    "ETS2"    "ETV1"    "ETV2"    "ETV3"   
# [33] "ETV4"    "ETV5"    "ETV7"    "FEV"     "FLI1"    "FOXO1"   "GABPA"   "GABPB1" 
# [41] "GATAD1"  "HOXA2"   "HOXA3"   "KMT2B"   "ONECUT2" "SOX15"   "TFAP2C"  "ZBTB11" 
# [49] "ZBTB25"  "ZNF580" 
...
#  TEAD1 is in DEG of cluster1
# ELF2 is in DEG of cluster1
# ETS2 is in DEG of cluster1
# ETV1 is in DEG of cluster5
   ...
   for(i in x){
	...
	print(key_TFs) #  "ARL4C" "BMP4"  "PRRX1" "TEAD1" "ELF2"  "ETS2"  "ETV1" 
...
# BMP4              
# PRRX1             
# TEAD1    30 42   cisTarget_CEBPA;CEBPB;CEBPD;CEBPE;CEBPG;PDX1;SOX9;SRY;TEAD1.motif_target cisTarget_SOX9;TEAD1.motif_target 
# ELF2     35      cisTarget_DLX2;DLX3;DRGX;ELF1;ELF2;ELF3;ELF4;ELK1;ELK3;ELK4;ERF;ERG;ETS1;ETS2;ETV1;ETV2;ETV3;ETV4;ETV5;ETV7;FEV;FLI1;FOXO1;GABPA;GABPB1;GATAD1;HOXA2;HOXA3;KMT2B;ONECUT2;SOX15;TFAP2C;ZBTB11;ZBTB25;ZNF580.motif_target 
# ETS2     35      cisTarget_DLX2;DLX3;DRGX;ELF1;ELF2;ELF3;ELF4;ELK1;ELK3;ELK4;ERF;ERG;ETS1;ETS2;ETV1;ETV2;ETV3;ETV4;ETV5;ETV7;FEV;FLI1;FOXO1;GABPA;GABPB1;GATAD1;HOXA2;HOXA3;KMT2B;ONECUT2;SOX15;TFAP2C;ZBTB11;ZBTB25;ZNF580.motif_target 
# ETV1     35      cisTarget_DLX2;DLX3;DRGX;ELF1
   x
# ARL4C  BMP4 PRRX1 TEAD1  ELF2  ETS2  ETV1 
    # 0     0     0    30    35    35    35 
...
#	# [1] 30 35 42
#	colnames(mat)[x]
# [1] "cisTarget_CEBPA;CEBPB;CEBPD;CEBPE;CEBPG;PDX1;SOX9;SRY;TEAD1.motif_target"                                                                                                                                               
# [2] "cisTarget_DLX2;DLX3;DRGX;ELF1;ELF2;ELF3;ELF4;ELK1;ELK3;ELK4;ERF;ERG;ETS1;ETS2;ETV1;ETV2;ETV3;ETV4;ETV5;ETV7;FEV;FLI1;FOXO1;GABPA;GABPB1;GATAD1;HOXA2;HOXA3;KMT2B;ONECUT2;SOX15;TFAP2C;ZBTB11;ZBTB25;ZNF580.motif_target"
# [3] "cisTarget_SOX9;TEAD1.motif_target"   
