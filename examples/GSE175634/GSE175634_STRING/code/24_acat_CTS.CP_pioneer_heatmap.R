...
ann_colors <- list(
  coding = c(no = "lightgrey", yes = "blue"),
...
# the, add a dashed line between ISL1 and its targets in the PPIs, according to "Maven2023_gene_ISL1_WT_d6CP"
...
# print(p)
# dev.off()
# write.table(mat, file='heatmap_blocked_CTS.CP.1_scATAC_Maven2023_gene_ISL1_v2.tsv', sep='\t', quote=FALSE, row.names=TRUE, col.names=TRUE)
