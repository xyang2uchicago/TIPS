...
promoter_open_dir = 'F:/projects/scATAC/results/GSE181346_heart/scATACseq/'
# . refer to 3.1_lineage_stage_specific_promoter.R 
annotation = readRDS( file=paste0(promoter_open_dir, "CPpoolvsmesoderm_promoter_accessibility_annotation.rds"))
dim(annotation)  #[1]  237012     32
length(unique(annotation$symbol)) #[1] 59385
#length(unique(annotation$symbol[which(annotation$gene_type == "protein_coding")])) #[1] 19930
colnames(annotation)
#  [1] "chr"                    "start"                  "end"                    "transcript"            
#  [5] "symbol"                 "gene_type"              "PCW6CP_access"          "PCW8_CM_access"        
#  [9] "PCW8_CF_access"         "PCW8_SMC_access"        "PCW19_CM_access"        "PCW19_CF_access"       
# [13] "PCW19_SMC_access"       "CP_first_in_CM"         "CP_first_in_CF"         "CP_first_in_SMC"       
# [17] "PCW8_CM_specific"       "PCW8_CF_specific"       "PCW8_SMC_specific"      "PCW19_CM_specific"     
# [21] "PCW19_CF_specific"      "PCW19_SMC_specific"     "biotype_simple"         "PCW6PCW8_CM_specific"  
# [25] "PCW6PCW8_CF_specific"   "PCW6PCW8_SMC_specific"  "PCW8PCW19_CM_specific"  "PCW8PCW19_CF_specific" 
# [29] "PCW8PCW19_SMC_specific" "PCW6PCW19_CM_specific"  "PCW6PCW19_CF_specific"  "PCW6PCW19_SMC_specific"

####### quantify cluster-annotation --all transcripts
int_cutoff = readRDS( file=paste0(promoter_open_dir, "CPpoolvsmesoderm_promoter_accessibility_cutoff_top25.rds"))
int_cutoff
#  PCW6CP_access   PCW8_CM_access   PCW8_CF_access  PCW8_SMC_access  PCW19_CM_access  PCW19_CF_access PCW19_SMC_access 
#           0.0930           0.0885           0.1070           0.0920           0.4265           0.1595           0.0590 
 
for(i in names(int_cutoff)){
    annotation[[i]] = ifelse(annotation[[i]] > quantile(annotation[[i]], 0.75), 1, 0)
}

subset(annotation, symbol=='ISL1')
#        chr    start      end         transcript symbol      gene_type PCW6CP_access PCW8_CM_access PCW8_CF_access PCW8_SMC_access
# 64990 chr5 51382448 51384448 ENST00000230658.12   ISL1 protein_coding             1              1              1               1
# 64991 chr5 51382672 51384672  ENST00000511384.1   ISL1 protein_coding             1              1              1               1
# 64992 chr5 51385204 51387204  ENST00000505475.3   ISL1 protein_coding             0              0              0               0
#       PCW19_CM_access PCW19_CF_access PCW19_SMC_access CP_first_in_CM CP_first_in_CF CP_first_in_SMC PCW8_CM_specific PCW8_CF_specific
# 64990               0               0                0              0              0               0                0                0
# 64991               0               0                0              0              0               0                0                0
# 64992               0               0                0              0              0               0                0                0
#       PCW8_SMC_specific PCW19_CM_specific PCW19_CF_specific PCW19_SMC_specific biotype_simple PCW6PCW8_CM_specific
# 64990                 0                 0                 0                  0 protein_coding                    1
# 64991                 0                 0                 0                  0 protein_coding                    1
# 64992                 0                 0                 0                  0 protein_coding                    0
#       PCW6PCW8_CF_specific PCW6PCW8_SMC_specific PCW8PCW19_CM_specific PCW8PCW19_CF_specific PCW8PCW19_SMC_specific
# 64990                    1                     1                     0                     0                      0
# 64991                    1                     1                     0                     0                      0
# 64992                    0                     0                     0                     0                      0
#       PCW6PCW19_CM_specific PCW6PCW19_CF_specific PCW6PCW19_SMC_specific
# 64990                     0                     0                      0
# 64991                     0                     0                      0
# 64992                     0                     0                      0
...
# atac_list = list()
# for(i in colnames(annotation)[c(7:32)]) {
#     if(i != 'biotype_simple') atac_list[[i]] = annotation$symbol[which(annotation[[i]] > 0)] %>% unique
#     if(any(is.na(atac_list[[i]]))) {
#         atac_list[[i]] = atac_list[[i]][!is.na(atac_list[[i]])]
#     }
# }
# lengths(atac_list)
# #          PCW6CP_access         PCW8_CM_access         PCW8_CF_access        PCW8_SMC_access        PCW19_CM_access 
# #                  11323                  11248                  11297                  11316                  11386 
# #        PCW19_CF_access       PCW19_SMC_access         CP_first_in_CM         CP_first_in_CF        CP_first_in_SMC 
# #                  11381                  11393                   1402                    443                    611 
# #       PCW8_CM_specific       PCW8_CF_specific      PCW8_SMC_specific      PCW19_CM_specific      PCW19_CF_specific 
# #                    597                   1304                   1140                    848                    769 
# #     PCW19_SMC_specific   PCW6PCW8_CM_specific   PCW6PCW8_CF_specific  PCW6PCW8_SMC_specific  PCW8PCW19_CM_specific 
# #                   1155                    562                    586                    856                   1536 
# #  PCW8PCW19_CF_specific PCW8PCW19_SMC_specific  PCW6PCW19_CM_specific  PCW6PCW19_CF_specific PCW6PCW19_SMC_specific 
# #                   1315                   1167                    500                    451                    632 
...
### understand CTS.CP.1 ######
annotation_sub = subset(annotation, symbol %in% CTS[['CP.1']])
length(unique(CTS[['CP.1']]))  # 87
dim(annotation_sub) #[1] [1] 597  32   > 87
length(unique(annotation_sub$symbol)) # 82

# teh non-coding tenes
x = table(annotation_sub$symbol, annotation_sub$gene_type)
x$protein_coding
x[which(x[,'protein_coding']==0),]           
#             misc_RNA Mt_tRNA processed_pseudogene protein_coding transcribed_unprocessed_pseudogene
#   LINC00888        0       0                    0              0                                  4
#   MT-TF            0       1                    0              0                                  0
#   MT-TL1           0       1                    0              0                                  0
#   MT-TS2           0       1                    0              0                                  0
...
# unique transcript per gene
x[which(apply(x,1,sum)==1),]      
#            misc_RNA Mt_tRNA processed_pseudogene protein_coding transcribed_unprocessed_pseudogene
#   BMP5            0       0                    0              1                                  0
#   HAS2            0       0                    0              1                                  0
#   MT-TF           0       1                    0              0                                  0
...
annotation_sub$CTS.CP.1 = ifelse(annotation_sub$symbol %in% CTS[['CP.1']], '1', '0')
annotation_sub$CP_hi = ifelse(annotation_sub$symbol %in% DEG[['CP']], '1', '0')
annotation_sub$CM_hi = ifelse(annotation_sub$symbol %in% DEG[['5']], '1', '0')
annotation_sub$CF_hi = ifelse(annotation_sub$symbol %in% DEG[['1']], '1', '0')
annotation_sub$SMC_hi = ifelse(annotation_sub$symbol %in% DEG[['muscle']], '1', '0')
annotation_sub$CMES_hi = ifelse(annotation_sub$symbol %in% DEG[['4']], '1', '0')

annotation_sub$Maven2023_gene_ISL1_up_E = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL_up_E']], '1', '0')
annotation_sub$Maven2023_gene_ISL1_up_T = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL_up_T']], '1', '0')
annotation_sub$Maven2023_gene_ISL1_up_L = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL_up_L']], '1', '0')

annotation_sub$Maven2023_gene_ISL1_dn_E = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL_dn_E']], '1', '0')
annotation_sub$Maven2023_gene_ISL1_dn_T = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL_dn_T']], '1', '0')
annotation_sub$Maven2023_gene_ISL1_dn_L = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL_dn_L']], '1', '0')

annotation_sub$Maven2023_gene_ISL1_WT_d6CP  = ifelse(annotation_sub$symbol %in% ISL1_set[['Maven2023_gene_ISL1_WT_d6CP']], '1', '0')
annotation_sub$Gao2019_gene_Isl1_E825E9.bound  = ifelse(annotation_sub$symbol %in% ISL1[['Isl1.embryo.bound']], '1', '0')
annotation_sub$Gao2019_gene_Isl1.iCPC_CPC.bound = ifelse(annotation_sub$symbol %in% ISL1[['Isl1.iCPC_CPC.bound']], '1', '0')

colnames(annotation_sub)
# [1] "chr"                            "start"                          "end"                           
#  [4] "transcript"                     "symbol"                         "gene_type"                     
#  [7] "PCW6CP_access"                  "PCW8_CM_access"                 "PCW8_CF_access"                
# [10] "PCW8_SMC_access"                "PCW19_CM_access"                "PCW19_CF_access"               
# [13] "PCW19_SMC_access"               "CP_first_in_CM"                 "CP_first_in_CF"                
# [16] "CP_first_in_SMC"                "PCW8_CM_specific"               "PCW8_CF_specific"              
# [19] "PCW8_SMC_specific"              "PCW19_CM_specific"              "PCW19_CF_specific"             
# [22] "PCW19_SMC_specific"             "biotype_simple"                 "PCW6PCW8_CM_specific"          
# [25] "PCW6PCW8_CF_specific"           "PCW6PCW8_SMC_specific"          "PCW8PCW19_CM_specific"         
# [28] "PCW8PCW19_CF_specific"          "PCW8PCW19_SMC_specific"         "PCW6PCW19_CM_specific"         
# [31] "PCW6PCW19_CF_specific"          "PCW6PCW19_SMC_specific"         "CTS.CP.1"                      
# [34] "CP_hi"                          "CM_hi"                          "CF_hi"                         
# [37] "SMC_hi"                         "CMES_hi"                        "Maven2023_gene_ISL1_up_E"      
# [40] "Maven2023_gene_ISL1_up_T"       "Maven2023_gene_ISL1_up_L"       "Maven2023_gene_ISL1_dn_E"      
# [43] "Maven2023_gene_ISL1_dn_T"       "Maven2023_gene_ISL1_dn_L"       "Maven2023_gene_ISL1_WT_d6CP"

int = c("CMES_hi" ,"CP_hi", "CM_hi", "CF_hi", "PCW6CP_access", 
        "CP_first_in_CM" , "PCW8_CM_access", "PCW19_CM_access", 
         "CP_first_in_CF" ,"PCW8_CF_access","PCW19_CF_access" 
...
rownames(mat) <- annotation_sub$symbol
dim(mat) #[1] 597  18
length(unique(rownames(mat))) # 82
...
# [1] "AC108052.1" "KIAA1324L"  "AL035078.1" "H1F0"       "AC078993.1"
...
Is_protein_coding = ifelse(annotation_sub[match(rownames(mat), annotation_sub$symbol),]$gene_type == "protein_coding", TRUE, FALSE)
...
if(!(coding_target_only)   ann_colors[['coding']]  c(no = "lightgrey", yes = "blue"),
...
# mat[,'CP_hit'] = ifelse(mat[,'CP_hi'] == 1 & (mat[,'PCW6CP_access'] == 1  ), 1, 0)   # | (mat[,'PCW8_CM_access'] == 1  trial 1 not used !
# # 3) must be open at PCW8_CM or PCW19_CM for CM_hi
# mat[,'CM_hit'] = ifelse(mat[,'CM_hi'] == 1 & (mat[,'PCW8_CM_access'] == 1 | mat[,'PCW19_CM_access'] == 1 ), 1, 0) 
# # 4) must be open at PCW8_CF or PCW19_CF for CF_hi
# mat[,'CF_hit'] = ifelse(mat[,'CF_hi'] == 1 & (mat[,'PCW8_CF_access'] == 1 | mat[,'PCW19_CF_access'] == 1 ), 1, 0) 
...
# 1) must be  CP_hi, CM_hi or CF_hi
# 2) must be open at CP_pool for CP_hi PPI
mat[,'CP_hit'] = ifelse(mat[,'CP_hi'] == 1 & mat[,'ISL1_CP_bound']  == 1 , 1, 0)   
# 3) must be open at PCW8_CM or PCW19_CM for CM_hi
mat[,'CM_hit'] = ifelse(mat[,'CM_hi'] == 1  & mat[,'ISL1_CP_bound']  , 1, 0) 
# 4) must be open at PCW8_CF or PCW19_CF for CF_hi
mat[,'CF_hit'] = ifelse( mat[,'CF_hi'] == 1 & mat[,'ISL1_CP_bound'] , 1, 0) 
...
pattern <- paste0(mat[, "CP_hit"], mat[, "CM_hit"], mat[, "CF_hit"])
table(pattern)
# pattern
...
ord <- order(block)
cols_to_show <- c("CP_hit",   "CP_hi"   ,   "PCW6CP_access"    , #"PCW8_CM_access"  , 
                "CM_hit"   ,  "CM_hi"  ,    "PCW8_CM_access"  , "PCW19_CM_access",
                "CF_hit"   ,  "CF_hi"  ,    "PCW8_CF_access"  , "PCW19_CF_access"  ,
...
if(coding_target_only) pdf(file='heatmap_blocked_CTS.CP.1_scATAC_Maven2023_gene_ISL1_v2_coding_target.pdf', height=9) else 
pdf(file='heatmap_blocked_CTS.CP.1_scATAC_Maven2023_gene_ISL1_v2.pdf', height=9)
print(p)
dev.off()

if(coding_target_only) fileName='heatmap_blocked_CTS.CP.1_scATAC_Maven2023_gene_ISL1_v2_coding_target.tsv' else fileName='heatmap_blocked_CTS.CP.1_scATAC_Maven2023_gene_ISL1_v2.tsv'
...
GRN_node_list = list( HiG_CM = rownames(mat)[which(mat[,"CM_hit"] == 1)],
                      HiG_CF = rownames(mat)[which(mat[,"CF_hit"] == 1)],
                      CTS_CP.1 = rownames(mat)[which(mat[,"CP_hit"] == 1)])
...
saveRDS(graph_ISL1_list, file='PPI_graph_ISL1_GRN_prediction_v2.rds')
...
pdf(file='PPI_graph_ISL1_GRN_prediction_v2.pdf')
