...
species      <- "human"
# leiden_0.5_type contains renamed cluster labels (3->CP, 8->muscle, 11->endoderm)
...
CTS_ID  <- "CP"
seed_TF <- "HOXB2"  # from 12.0: top PageRank in HiGCTS_CP with BetweennessCentrality > 0
...
graph_list[[1]]
# IGRAPH UNW- 325 10066 --
# + attr: name (v/c), weight (v/n), FDR (v/n), ...
DEG[[1]]
# [1] "L1TD1"     "TERF1"     "MIR302CHG" ...
CTS[[1]]
# [1] "NPPB"  "NEXN"  "TSPAN2" ...
