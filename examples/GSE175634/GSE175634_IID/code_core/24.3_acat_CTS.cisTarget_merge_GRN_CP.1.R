rebuild_mat <- FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/GSE175634/GSE175634_IID/code_core/24.0_acat_load_input_clean_CP.1.R")
...
key_TFs
# [1] "GATA3" "KLF6"  (or subset, depending on vcount > 0)
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = 36 ecount = 79
    # CM merged graph: vcount = 29 ecount = 54
