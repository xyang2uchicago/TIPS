...
rebuild_mat <- TRUE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/GSE175634/GSE175634_IID/code_core/24.0_acat_load_input_clean.R")
...
## IID graph uses HiG_{CTS_ID} and CTS_{CTS_ID} naming;
## the TIPS library version looks for HiGCTS_{CTS_ID} which differs in semantics.
