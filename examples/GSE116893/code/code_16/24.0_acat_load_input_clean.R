...
CTS_ID       <- "16"
CP_cluster   <- "16"               # CTS cluster = CP (ADRN<->MES plasticity cluster)
CM_cluster   <- "7"                # terminal ADRN-Proliferating (progenitor direction)
CF_cluster   <- "9"                # terminal MES/SCP-bridge cluster (alternative fate)
...
# cisTarget_targets_in_all_CTS.rds covers all significant CTS (15, 16, 9) in one run.
# If already computed for results_15, copy it here to avoid rerunning:
#   file.copy("../results_15/cisTarget_targets_in_all_CTS.rds", ".")
#   file.copy("../results_15/cisTarget_targets_in_two_HiGs.rds", ".")
