rebuild_mat <- FALSE
source("C:/Users/felix/Documents/GitHub/TIPS/examples/GSE116893/code/code_9/24.0_acat_load_input_clean.R")
...
# [1] "PPI_graph_GRN_prediction_CTS_9_dualpull_final_table.tsv"
...
for (lk in unique(final_table$linkage)) {
    ...
    # CM merged graph: vcount = 4   ecount = 4
