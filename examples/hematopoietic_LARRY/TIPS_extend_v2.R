## =============================================================================
## TIPS_extend_v2.R — full TIPS helper library (the only version; source this file)
## =============================================================================
##
##   Part 1 — dual-pull candidate assignment and key-TF selection (24.1 setup)
##   Part 2 — lineage-lean gene modules (post dualpull_final_table.tsv)
##
## TIPS_extend.R (Part 1 only) has been retired; every arm now sources this
## file. Used by both single_cell/ and metacell/ arms via tips_extend_r_path()
## in each 00_configuration.R.
##
