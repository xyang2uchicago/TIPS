## Larry GSE140802 MuTrans TIPS — IID, TAG 4_9vs11 (CP4 Baso / CF11 Meg)
## Full docs: README.md in this folder (IID PPIN via iid_global_rds)
...
code_dir <- paste0(
  "F:/projects/TIPS/source/GSE140802_lineage_tracking/7_data_MuTrans_TIPS_IID/code_core_",
  TAG
)
...
source(file.path(code_dir, "mutrans_sce_xy.R"))   # reload fixed helpers
	...
	source(file.path(code_dir, "11.1_IIDweighted_CTS_network.R"))
...
# CF merged graph: vcount = 9 ecount = 15
# [24.3] done.
