...
df = df[grepl("_cardiac.a$", df$signature), ]
...
edge_data <- extract_edge_weights_by_category(graph_list, PPI_color_palette, "cardiac.a")
(head(edge_data, 3))
#          sample PPI_cat edge_weight num_edges cluster_ID cluster_cat
# 1 HiG_cardiac.a     HiG       0.225      6513  cardiac.a    unstable
# 2 HiG_cardiac.a     HiG       0.211      6513  cardiac.a    unstable
# 3 HiG_cardiac.a     HiG       0.259      6513  cardiac.a    unstable
...
# 1 edge_weight CTS    HiGCTS    79    28     1004. 0.47  0.47  ns          
# 2 edge_weight CTS    HiG       79  6513   287330. 0.074 0.111 ns          
# 3 edge_weight HiGCTS HiG       28  6513   110373  0.054 0.111 ns  
}
