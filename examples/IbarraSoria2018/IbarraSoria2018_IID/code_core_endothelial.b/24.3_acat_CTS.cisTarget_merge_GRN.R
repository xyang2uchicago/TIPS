rebuild_mat <- FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/IbarraSoria2018/IbarraSoria2018_IID/code_core_endothelial.b/24.0_acat_load_input_clean.R")
...
# [1] "PPI_graph_GRN_prediction_CTS_endothelial.b_dualpull_final_table.tsv"
...
for (lk in unique(final_table$linkage)) {
    ...
    # CF merged graph: vcount = 8    ecount = 10
    # CM merged graph: vcount = 3    ecount = 2
