...
rebuild_mat <- TRUE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/IbarraSoria2018/IbarraSoria2018_IID/code_core/24.0_acat_load_input_clean.R")

source(paste0('https://raw.githubusercontent.com/xyang2uchicago/TIPS/refs/heads/main/R/celltype_specific_weight_v', celltype_specific_weight_version, '.R'))

## check the loaded objects =========================
seed_TF  # "GATA4" "TBX5"  "MSX2"  -- from CTS_cardiac.a (code 12.0)
CTS_ID   # "cardiac.a"
...
if (length(files) > 0) {
    ...
    key_TFs
    #  [1] "GATA4"  "TBX5"   "MSX2"   "CBFB"   "GATA5"  "GATA6"  "HMGA2"  "ETV2"   "PRDM6"  "RBFOX2"
    ...
    names(x) <- key_TFs
    # GATA4   -> col for GATA family (CRX;DBP;...;GATA4;...) motif_target
    # TBX5    -> 0  (no cisTarget column)
    # MSX2    -> 0  (no cisTarget column)
    # CBFB    -> col for CBFB.motif_target
    # GATA5   -> same col as GATA4 (same GATA family motif)
    # GATA6   -> same col as GATA4 (same GATA family motif)
    ...
    ## MANUAL SELECTION: drop TBX5/MSX2 (no cisTarget col); keep one from GATA family (GATA4, drop GATA5/6)
...
# => PPI_graph_<key>_GRN_prediction_CTS_cardiac.a_v3.pdf
