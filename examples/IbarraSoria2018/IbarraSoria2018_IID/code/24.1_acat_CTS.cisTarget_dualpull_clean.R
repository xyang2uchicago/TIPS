...
rebuild_mat <- FALSE
source("/Users/felixyu/Documents/GitHub/TIPS/examples/IbarraSoria2018/IbarraSoria2018_IID/code/24.0_acat_load_input_clean.R")

source("/Users/felixyu/Documents/GitHub/TIPS/R/celltype_specific_weight_v10.R")

## check the loaded objects =========================
seed_TF_2018 # "GATA4" "TBX5"  "MSX2"  # by top PageRank in code 12.xxxx
names(graph_list)
...
if (length(files) > 0) {
  ...
  print(key_TFs) #  "MEF2C"  "GATA4"  "MSX2"   "CBFB"   "GATA5"  "GATA6"  "HMGA2"  "ETV2"   "PRDM6"  "RBFOX2" STRING FOR REFERENCE ONLY!!!
  #  [1] "GATA4"  "TBX5"   "MSX2"   "CBFB"   "GATA5"  "GATA6"  "HMGA2"  "ETV2"
  #  [9] "PRDM6"  "RBFOX2"
  ...
  # RBFOX2   74      cisTarget_RBFOX2.motif_target
  x
  #  GATA4   TBX5   MSX2   CBFB  GATA5  GATA6  HMGA2   ETV2  PRDM6 RBFOX2
  #     33      0      0     31     33     33     40     62     63     74

  key_TFs <- c("GATA4", "CBFB", "HMGA2", "ETV2", "PRDM6", "RBFOX2") # DONT NEED GATA5/6
  x <- x[key_TFs]
  if (length(x) > 0) {
...
dim(mat) # [1] 37 100
# Deviates from string above, string was 54 71
