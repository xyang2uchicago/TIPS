## 24.3_acat_CTS.cisTarget_merge_GRN.R — code_core_mouse_8 (IID, C8 arm, CORE)
##
## Mirrors GSE87038_STRING/code_core_mouse_8/24.3...R (see that file's header for the
## full rationale): sources code_core_mouse_8/24.0, reads/writes
## results_core_mouse_8/cisTarget_predicted_8, uppercases graph_list to match
## final_table's gene names, and uses pdf()+dev.off() (not plot()+dev.copy2pdf(), which
## needs an active screen device unavailable under headless Rscript).
...
updir <- here::here("examples", "cardiac", "GSE87038", "GSE87038_IID", "results_core_mouse_8")
